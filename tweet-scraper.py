...
if __name__ == "__main__":
    redisDataBase = "tweets_scraped"
    scrape_twitter(400, 'stock market', redisDataBase)
    ...
    plt.tight_layout()
    plt.savefig('/Users/austinspencer/Documents/tw-bot/plot.png')
    api.update_with_media('/Users/austinspencer/Documents/tw-bot/plot.png', to_string)
